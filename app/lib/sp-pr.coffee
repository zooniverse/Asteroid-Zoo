module.exports =
  ...
  home:
    header:
      title: 'La buzqueda de asteroides!'
      content: '''

      Usando datos del Catalina Sky Survey, cientificos estan rastreando nuestro sistema solar en busca de asteroides. Necesitan tu ayuda para aprender sus contenidos minerales.     

      '''
      start: 'Start Classifying'
      getClassifying: 'Empieza a clasificar!'
      learnMore: 'Aprende Mas'
    whatDo:
      title: 'Como puedes ayudar?'
      content: '''
  ...
  classifier:
    ...
    type:
      ...
      nothing:
        label: 'Nada'
    rightPanel:
      summaryHeader: "Buen trabajo!"
      whatKindScreen: "Para continuar marcando, por favor selecione Asteroide, Artefacto, o Nasa en el menu superior"
      knownAsteroid: "Esta imagen contiene al menos un asteroide (circulado en verde)."
      summaryBody: "Puedes discutic esto en Talk, compartirlo, or anadirlo a Tus Favoritos!"
      asteroidDoneScreen: "Para acabar necesitas marcar un asteroide, o declararlo no visibleYou must mark an asteroid or declare not visible in all 4 frames to click done"
